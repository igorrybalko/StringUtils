   ...
   <div className='d-flex'>
    <div className='mr-10'>
     <a
      ...
      rel='nofollow'
     >
      <img width='32' src='/img/icon-fb.svg' alt='' />
     </a>
    </div>
    <div className='mr-10'>
     <a href={`https://x.com/share?&url=${url}`} target='_blank' rel='nofollow'>
      <img width='32' src='/img/icon-x.svg' alt='' />
     </a>
    </div>
    <div className='mr-10'>
     <a
      ...
      rel='nofollow'
     >
      <img width='32' src='/img/icon-ld.svg' alt='' />
     </a>
    </div>
   </div>
  </div>
