...
export default function PrivacyPolicyPage() {
 return (
  <div>
   ...
   <p>
    At String Utils, accessible from https://stringutils.online, one of our main
    priorities is the privacy of our visitors. This Privacy Policy document
    contains types of information that is collected and recorded by String Utils
    and how we use it.
   </p>
   ...
   <p>
    ...
    and/or collect in String Utils. This policy is not applicable to any
   ...
   <p>
    String Utils follows a standard procedure of using log files. These files
   ...
   <p>
    Like any other website, String Utils uses "cookies". These cookies are used
   ...
   <p>
    ...
    advertising partners of String Utils.
   </p>

   <p>
    Third-party ad servers or ad networks uses technologies like cookies,
    JavaScript, or Web Beacons that are used in their respective advertisements
    and links that appear on String Utils, which are sent directly to users'
   ...
   <p>
    Note that String Utils has no access to or control over these cookies that
   ...
   <p>
    String Utils's Privacy Policy does not apply to other advertisers or
   ...
   <p>
    String Utils does not knowingly collect any Personal Identifiable
